...
from intent_ai.teacher.tasks import (AssetKind, EvidenceAsset, ItemSpec, Modality, TaskItem,
                                          TaskLine)
...
def test_no_contract_instruction_carries_a_real_key():
    ...
    from intent_ai.teacher import contracts
    task = _task()
...
def test_adapter_renames_schema_to_the_sdk_alias_at_the_boundary():
    ...
    from intent_ai.teacher.openrouter import _sdk_response_format
...
def test_rate_limit_429_retries_on_a_separate_window_clearing_budget(monkeypatch):
    ...
    from intent_ai.teacher import openrouter as orc
...
def test_reasoning_cap_changes_fingerprint_only_when_set():
    ...
    from intent_ai.teacher.contracts import ResponseContract
    from intent_ai.teacher.panel import _fingerprint
...
def test_resume_cache_excludes_truncated_and_empty_replies():
    ...
    from intent_ai.teacher.panel import resume_cache
