...
from intent_ai.annotations import LabelSource, LineLabel, PanelVote, load_labels
from intent_ai.identity import Label, LineId
...
def _human_seed(lid: LineId, label: Label) -> LineLabel:
    return LineLabel(id=lid, label=label, source=LabelSource.HUMAN, confidence=None,
                     audit_status="adjudicated", notes="", provenance={}, line_text_hash="seed")
