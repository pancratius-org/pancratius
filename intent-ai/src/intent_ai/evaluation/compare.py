...
from .metrics import (  # the two-class metric lives in metrics.py (one home)
    Metrics,
    balanced,
)
...
def score(records: RecordsByBook, labelset: LabelSet,
    ...
    return score_predictions(labelset, votes, predictions)
...
def score_predictions(
    ...
    """Judge an already-produced student prediction map; fitting belongs upstream."""
    ...
    return Comparison(rows=score_readers(truth, predictions, votes),
