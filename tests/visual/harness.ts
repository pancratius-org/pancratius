...
const AUDIT_ROUTES: readonly Route[] = [
  ...
  { name: "books-ru", path: "/ru/books/" },
  { name: "book-33-ru", path: "/ru/books/33-ya-esm-vsadnik-kon-i-mech/" },
  { name: "book-33-en", path: "/en/books/33-i-am-the-horseman-the-horse-and-the-sword/" },
  { name: "conceptosphere-ru", path: "/ru/conceptosphere/" },
  { name: "conceptosphere-en", path: "/en/conceptosphere/" },
  { name: "search-ru", path: "/ru/search/" },
  { name: "downloads-ru", path: "/ru/downloads/" },
  { name: "poetry-ru", path: "/ru/poetry/" },
  { name: "about-ru", path: "/ru/about/" },
  { name: "mission-ru", path: "/ru/mission/" },
  { name: "svetozar-ru", path: "/ru/svetozar/" },
  { name: "license-ru", path: "/ru/license/" },
  { name: "support-ru", path: "/ru/support/" },
  { name: "poem-1-ru", path: "/ru/poetry/01-a-esli-budu-ya-ne-prav/" },
  { name: "videos-ru", path: "/ru/videos/" },
  { name: "video-358-ru", path: "/ru/videos/358-7-zhizn-v-dolg-ili-v-dar-sistema-kotoraya-menyaet-vse/" },
  { name: "project-eai-ru", path: "/ru/projects/enlightened-ai/" },
