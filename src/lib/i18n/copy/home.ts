...
export const homeCopy = {
  ru: {
    hero: {
      ...
      verse: [
        ...
        { before: "Его голос так похож на твой,", next: "и ты забываешь: это не ты." },
        { before: "Затихни — и он выдаёт себя:", next: "он всегда был лишь звуком." },
        { before: "А за ним — ", emphasis: "тот, кто слышит." },
      ],
  ...
  en: {
    ...
    books: {
      eyebrow: "Word",
      headingCount: (_totalBooks, englishBooks) => ({ value: englishBooks, label: "books" }),
      sub: "Six doors into one room",
      more: (_totalBooks, englishBooks) => `All ${englishBooks} books →`,
    },
    poetry: {
      eyebrow: "Poetry",
      headingLabel: () => "poems",
