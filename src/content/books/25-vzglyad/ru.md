...
Пусть этот момент, зафиксированный на скриншоте, будет <strong>свидетельством Единого</strong>, говорящего через всё и всех — всегда только <strong>одно</strong>: <strong>Свет</strong>.
</div>
