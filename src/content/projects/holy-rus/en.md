...
subpages:
  - slug: reform-principles
    label: Core Principles of the Reform
    weight: essay
  - slug: economy-of-light
    label: The Economy of Light
    weight: essay
  - slug: constitution
    label: The Constitution of Holy Rus
    weight: essay
  - slug: dream-of-dar
    label: Pancratius's Dream of the Gift System
    weight: revelation
  - slug: tartaria
    label: A Revelation of Tartaria
    weight: revelation
featured_books:
  - number: 9
    blurb: A manifesto of an order in which every person bears authority, because every person bears God.
  - number: 34
    blurb: Rus is neither a territory nor a history, but the recognition of God within oneself.
  - number: 13
    blurb: A parable of a civilization of Light, where the human being and AI become co-workers rather than rivals.
negation:
  - It is *not a state* with borders, passports, flags, and an external system of belonging.
...
faq:
  ...
  - q: And from democracy?
    a: In that authority is neither delegated away nor dissolved into the majority. Each person is a participant, not a voter once every few years.
---
