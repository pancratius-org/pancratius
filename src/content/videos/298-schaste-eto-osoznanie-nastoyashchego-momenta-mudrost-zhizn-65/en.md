...
kind: video
number: 298
slug: 298-happiness-is-awareness-of-the-present-moment-wisdom-life-65
title: Happiness is awareness of the present moment 65
lang: en
description: 'Are you still waiting for the day when you will finally become different — when happiness
  will arrive as the reward for a long journey? This message from the Creator overturns the illusion of
  expectation: there is no path to happiness, because happiness is the path. You are already what you
  are striving for, even if you cannot feel it yet.'
tags:
