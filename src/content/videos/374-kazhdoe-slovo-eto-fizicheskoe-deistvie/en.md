...
kind: video
number: 374
slug: 374-every-word-is-a-physical-action
title: Every word is a physical action
lang: en
description: 'The power of words is revealed not in their beauty, but in whether they become action. There
  is no boundary between word and action: a true word is already the beginning of action, and a true action
  is a word spoken without sound.'
tags: []
